...
TEXeditor::TEXeditor(EditorWindow *in_win): win(in_win), ui(this, in_win), input(this, in_win), output(this, in_win) {
  ix= &in_win->ix;
  ...
  //defCamPos.set(0, 1, 20);    i3d stuff to del
  //camPos= defCamPos;
...
void TEXeditor::init() {
  ...
  //ix->cameraPersp.move(defCamPos, vec3(0, 0, 0));   REMOVED
  //computePerspective();                             REMOVED
...
/*
void TEXeditor::computePerspective() {
